...
<nav class="navbar navbar-inverse" style="margin-bottom:0px;">
  <div class="container">
    <div class="navbar-header">
      <a class="navbar-brand" href="user.jsp" align="center" style="font-size: 40px;"><b>NOT RED BUS BOOKING</b></a>
    </div>
...
<div class="testbox3"  style="float:right; margin-right:450px;">
        <h1>Book Bus Tickets</h1>
          ...
          <br>
          <select name="class"">
              <option value="silver">Front Rows(1-3) - Rs.100</option>
              <option value="gold">Middle Rows(4-7) - Rs.150</option>
              <option value="platinum">Back Rows(8-10) - Rs.200</option>
        </select>
          <br /><br />
